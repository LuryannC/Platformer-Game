...
GameWin::GameWin(Data& data, GamePlay& game_play) : State(data), game_play(game_play)
{
}
...
void GameWin::update(float dt, GameStates& current_state, sf::Event& event)
{
...
void GameWin::render(sf::Event event)
{
...
void GameWin::mouseClicked(sf::Event event, GameStates& current_state)
{
  if (inside_play)
  {
...
void GameWin::keyPressed(sf::Event event, GameStates& current_state)
{

  State::keyPressed(event, current_state);
}

void GameWin::resetState(GameStates& current_state)
{
